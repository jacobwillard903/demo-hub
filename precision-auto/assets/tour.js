/* ============================================================
   Precision Auto Care demo - guided walkthrough ("walkme")
...
(function () {
  ...
  function build() {
    ...
    root.innerHTML =
      ...
      '  <p class="tour-body"></p>' +
      '  <div class="tour-foot">' +
      '    <div class="tour-progress"><span class="tour-count"></span><div class="tour-dots"></div></div>' +
      '    <div class="tour-btns">' +
  ...
  function cleanup() {
    ...
    var t = document.querySelector("#tour-switch");
  ...
  // public
  window.Tour = { start: start, end: end, isLive: function () { return live; } };

  // launchers + cross-page resume
