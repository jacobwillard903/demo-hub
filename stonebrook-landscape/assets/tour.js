/* ============================================================
   Stonebrook, guided walkthrough ("walkme")
   Shared, zero-dependency. Each page sets window.TOUR = [steps].
   A step: { el:'<css selector>'|null, title, body, side, cta, pre, elm }
     - el     : element to spotlight. null = centered card (no spotlight).
     - elm    : mobile fallback selector when el is hidden at this width.
